...
\begin{document}
    ...
    \begin{LARGE}
    \begin{tabular}{cc<{\hspace{1em}}|>{\hspace{1em}}c}
        \multicolumn{2}{c}{\Large{\textbf{Lenguajes}}} & \Large{\textbf{Tecnologías}}\\[.5ex]
        ...
        \multicolumn{2}{c|}{\Large{\textbf{Herramientas}}} & \faWindows \hspace{.1em} WPF\\
