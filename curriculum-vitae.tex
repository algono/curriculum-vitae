...
\begin{adjustwidth}{-1.5cm}{}
    \begin{tikzpicture}
        ...
        \node[category] (desktop) at (5,0) {Aplicaciones de Escritorio};
        \node[category] (tools) at (0,-10) {Herramientas};
        \node[subcategory] (dotnet) at (0.5,3) {.NET};
        ...
        \node[skill] (js) at (-3.5,-0.2) {{\fontsize{30pt}{30pt}\faJs}\\\textbf{JavaScript}};
        \node[skill] (php) at (-6.25,-0.75) {\fontsize{40pt}{40pt}\faPhp};
        \node[skill,text width=2.5cm] (wordpress) at (-8.5,-1.5) {{\fontsize{30pt}{30pt}\faWordpress}\\\textbf{WordPress}};
        \node[skill] (elementor) at (-6,-3.2) {{\fontsize{30pt}{30pt}\faElementor}\\\textbf{Elementor}};
        \node[skill] (csharp) at (0,4) {\includesvg[scale=1.3]{csharp.svg}};
        \node[skill-circle] (wpf) at (1.3,1) {WPF};
        \node[skill, font=\normalsize] (unity) at (3.1,2.1) {{\fontsize{30pt}{30pt}\faUnity}\\\textbf{Unity}};
