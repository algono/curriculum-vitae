...
\begin{document}
    ...
    \begin{tabular}{cc|c}
        ...
        TypeScript & \faDatabase \hspace{.1em} SQL & \iconoGitHub \hspace{.1em} GitHub\\
        \faJs \hspace{.1em} JavaScript & \faLinux \hspace{.1em} Bash & \faDatabase \hspace{.1em} Firebase\\
        Haskell & \faMarkdown \hspace{.1em} Markdown & \faMobile \hspace{.1em} Flutter\\
        \multicolumn{2}{c|}{\LaTeX} & \faUnity Unity\\
        \multicolumn{2}{c|}{\textbf{Herramientas}} & \faWindows \hspace{.1em} WPF\\\cline{1-2}
        VSCode & \faTrello \hspace{.1em} Trello & \faDocker \hspace{.1em} Docker\\
        \faWindows \hspace{.1em} Visual Studio & Sonarqube & \faAmazon \hspace{.1em} Alexa\\
    \end{tabular}
    \end{Huge}
