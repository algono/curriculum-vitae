...
\begin{adjustwidth}{-1.5cm}{}
    \begin{tikzpicture}
        ...
        \node[skill] (sonarqube) at (6.8,-6) {{\fontsize{30pt}{30pt}\includesvg{sonarqube.svg}}\\\rotatebox{10}{Sonarqube}};
...
\begin{itemize}
    \item \textbf{\href{https://orriolsarrandeterra.com/}{Orriols Arran de Terra}}: Página web destinada a la difusión de noticias y actividades del barrio de Els Orriols (Valencia)
    \item \textbf{\href{https://www.sabien.upv.es/project/value/}{VALUE}}: Uso de técnicas de \emph{Process Mining} (minería de procesos) para la mejora de la eficiencia en la gestión de la información en el sector de la salud
    \item \textbf{\href{http://www.sabien.upv.es/project/dial/}{DIAL}}: Tecnologías Asistivas de Voz Multiplataforma para la detección y abordaje de Soledad No Deseada en personas mayores
\end{itemize}
