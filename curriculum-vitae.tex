...
% https://tex.stackexchange.com/questions/150492/how-to-use-i\rule{0pt}{1em}ize-in-table-environment
...
\newcommand{\unigrades}[9]{
    \begin{tabular}{|ll<{\hspace{1em}}|>{\hspace{1em}}ll|}
        ...
        1er curso: & \tabitem \grade{#1} & 2{\textdegree} curso: & \tabitem \grade{#3} \\
        & \tabitem \mh{#2} && \tabitem \mh{#4} \\
        3er curso: & \tabitem \grade{#5} & 4{\textdegree} curso: & \tabitem \grade{#7} \\
        & \tabitem \mh{#6} && \tabitem \mh{#8} \\
