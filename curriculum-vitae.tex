...
\begin{itemize}
    ...
    \item {\large\textbf{\href{http://www.sabien.upv.es/project/dial/}{DIAL}}} (2022 - presente)
          \begin{itemize}
              ...
              \item Además, he configurado alrededor de 30 dispositivos \textbf{Raspberry Pi} para que funcionen como asistentes de voz
              \item Este conocimiento me ha servido para \textbf{configurar} otras \textbf{Raspberry Pi} y realizar \textbf{instalaciones en casas de pacientes} para el \textbf{proyecto europeo} \textbf{\href{http://www.sabien.upv.es/project/lifechamps/}{Lifechamps}} (2022 - presente)
          \end{itemize}
\end{itemize}
