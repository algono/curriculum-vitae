...
\newcommand{\contactinfo}{
    ...
    \end{minipage}
    \begin{center}
    Alejandro Gómez is a \textbf{Software engineer},\\currently \textbf{working} at the \textbf{\href{\sabienUrl}{\itacaSabien}} research group\\ from the \textbf{\href{\upvUrl}{\upvFull}}.
    \end{center}
}
...
\subsection*{Mid-level software engineer | \emph{\itacaSabienUpv}\\\textit{\large (March 2025 - present day)}}

After the project I was previously hired for ended, I came back to my previouse role as a \textbf{mid-level software engineer} at the \emph{\textbf{\href{\sabienUrl}{SABIEN}} (Technological innovations for Health and Wellbeing)} group from the \emph{Institute of Applied Information Technologies and Advanced Communications (\textbf{\href{http://www.itaca.upv.es/}{ITACA}})}, which is part of the \emph{{\upvName} (\textbf{\href{\upvUrl}{\upv}})}.

Same as before, my work consists on \textbf{developing applications} and providing \textbf{technical support} in various ways in the context of several \textbf{research projects}.

\subsection*{Research Support Staff | \emph{\ujiFull}\\\textit{\large (May 2024 - February 2025)}}

As \textbf{research support staff} in the \emph{\textbf{\href{\ujiGroupUrl}{\ujiGroup}}} group at \emph{\href{\ujiUrl}{\ujiFull}}, I participated in the \textbf{\emph{MINEGUIDE} project}, which aims to develop a \textbf{decision support system} in the field of \textbf{healthcare} using \textbf{process mining} and \textbf{clinical guidelines}. This is a collaboration between \emph{\ujiFull}, \emph{\upvFull}, and the \emph{University of Murcia (UMU)}.
...
\begin{itemize}
    \item {\large\textbf{\href{https://moveit.webs.upv.es/}{MOVE-IT}}} (2023 - 2024)
          \begin{itemize}
              ...
              \item The pilot tests involved a total of \textbf{17 participants} over a period of \textbf{2 weeks}, with a total of \textbf{158 gaming sessions}. A \textbf{77\%} of the participants \textbf{increased their use of smartphones} as a result of using the application, and their motivation remained high throughout the trial period
              \item A \textbf{research paper} was published about this project, myself being one of the authors: ``A. Henriksen, A. Martinez-Millana, A. Gomez-Noe, G. Hartvigsen, A. Anke, M. Stellander, D. Dybwad, T. Luzi, H. Michalsen, Piloting an Augmented Reality Exergame for Persons with Intellectual Disabilities, Intelligent Health Systems – From Technology to Data and Knowledge 2025. \url{https://doi.org/10.3233/shti250600}''.
          \end{itemize}
...
\subsubsection*{University projects}
